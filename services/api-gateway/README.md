...
- Authenticating and proxying `/api/ai/*` traffic to AI Service (port 5006) with SSE streaming support.
- Enforcing global rate limiting.
...
| `/api/ai/*` | AI Service | Gateway `authenticate()` (JWT) | `http://127.0.0.1:5006` |
...
| `AI_SERVICE_URL` | Downstream AI Service URL | `http://127.0.0.1:5006` | Yes |
